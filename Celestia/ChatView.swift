...
struct ChatView: View {
    ...
    var body: some View {
        ...
        .alert("Block \(otherUser.fullName)?", isPresented: $showingBlockConfirmation) {
            ...
            Text("They won't be able to see your profile or contact you. This will also remove them from your language partners.")
        }
        .detectScreenshots(
                    ...
                    ZStack {
                        if isSending {
                            ...
                            Image(systemName: (messageText.isEmpty && selectedImage == nil) ? "arrow.up.circle" : "arrow.up.circle.fill")
                                .font(.largeTitle)
                                .foregroundColor((messageText.isEmpty && selectedImage == nil) ? .gray.opacity(0.5) : .teal)
                        }
                    }
                    .frame(width: 44, height: 44)
                }
