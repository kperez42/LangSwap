...
struct TestData {
    ...
    static let discoverUsers: [User] = [
        ...
        User(
            ...
            gender: "Female",
            lookingFor: "Male",
            bio: "Artist & dreamer 🎨 | Yoga instructor 🧘‍♀️ | Plant mom 🌱 | Learning French to connect with art communities worldwide. Love discussing culture and creativity!",
            location: "Oakland",
            country: "USA",
            latitude: 37.8044,
            longitude: -122.2712,
        ...
        User(
            ...
            gender: "Male",
            lookingFor: "Female",
            bio: "Marketing director by day, DJ by night 🎧 | Music lover | Foodie | Fluent in Spanish and Portuguese, happy to help others learn while exploring music and culture!",
            location: "Berkeley",
            country: "USA",
            latitude: 37.8715,
            longitude: -122.2730,
