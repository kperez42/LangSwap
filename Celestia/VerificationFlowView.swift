...
struct VerificationFlowView: View {
    ...
    private func verificationOption(
        ...
        let accentColor: Color = isRecommended ? .teal : .blue
        ...
        return Button(action: action) {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 12)
                    .stroke(isRecommended && !isCompleted ? Color.teal.opacity(0.5) : Color.clear, lineWidth: 2)
            )
            .cornerRadius(12)
        }
    ...
    private var benefitsSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            benefitRow(icon: "person.2.fill", text: "Connect with more verified language partners")
